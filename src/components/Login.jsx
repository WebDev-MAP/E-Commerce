...
function Login() {
  ...
  return (
    <form onSubmit={handleLogin} className="flex flex-col">
      ...
      <button type="submit" className="px-4 py-2 bg-black text-white rounded-md hover:bg-white hover:text-black focus:outline-none focus:ring-2 focus:ring-gray-500 font-integral_cf shadow-lg animate-pulse">Login</button>
    </form>
  );
}
