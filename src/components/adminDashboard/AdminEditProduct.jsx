          ...
          <form className="w-full">
            <div className="flex flex-col gap-5">
              ...
              <section className="flex gap-3">
                ...
                <UploadZone setImage={setMainImg} img={mainImg} />
                <UploadZone setImage={setImg1} img={img1} />
                <UploadZone setImage={setImg2} img={img2} />
                <UploadZone setImage={setImg3} img={img3} />
              </section>
